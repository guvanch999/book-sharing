                ...
                <div class="card-group" >
                    ...
                    <div class="card p-2 p-lg-3" style="background-color: #DEDEDE">
                        ...
                        <div class="ml-4" style="width: 38%;float: left;height: 300px">
                            <h2 class="font-light" style="font-weight: bolder; text-transform: uppercase; text-align: center; color: green">Digital Platform For Book Sharing</h2>
                            <div >
                        		<p style="width: 100%; font-size: 18px;word-spacing: 2px; letter-spacing: 0.1px" align="justify">
                            With this platform unused printed materials and stationary can be passed on to the students from next generation. It also creates a nature of friendship student's heart and a wide community of students can come closer to each other through this platform.
                        </p>
